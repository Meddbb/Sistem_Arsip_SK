                            ...
                            <div>
                                ...
                                <select id="role"
                                    ...
                                    @foreach($divisions as $division)
                                        <option value="anggota_divisi_{{ $division->kode }}" {{ old('role', $user->role === 'anggota_divisi' && $user->division ? 'anggota_divisi_' . $user->division->kode : '') === 'anggota_divisi_' . $division->kode ? 'selected' : '' }}>
