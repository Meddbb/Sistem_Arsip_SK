<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('users.create') }}" class="bg-primary-600 hover:bg-primary-700 text-white px-4 py-2 rounded-md text-sm font-medium">
                                ...
                                @foreach($users as $user)
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            ...
                                            @elseif($user->role === 'anggota_divisi')
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                            @if($user->division)
                                                <div>{{ $user->division->nama }}</div>
                                                <div class="text-xs text-gray-400">{{ $user->division->kode }}</div>
                                            @else
